ServerEvents.recipes(event => {
    ...
    // Effortless Building Removals
    event.remove('effortlessbuilding:reach_upgrade1');
    event.remove('effortlessbuilding:reach_upgrade2');
    event.remove('effortlessbuilding:reach_upgrade3');
